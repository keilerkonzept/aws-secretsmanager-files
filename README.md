...
```bash
# Linux
curl -L https://github.com/keilerkonzept/aws-secretsmanager-files/releases/download/1.2.34/aws-secretsmanager-files_1.2.34_linux_x86_64.tar.gz | tar xz

# OS X
curl -L https://github.com/keilerkonzept/aws-secretsmanager-files/releases/download/1.2.34/aws-secretsmanager-files_1.2.34_osx_x86_64.tar.gz | tar xz

# Windows
curl -LO https://github.com/keilerkonzept/aws-secretsmanager-files/releases/download/1.2.34/aws-secretsmanager-files_1.2.34_windows_x86_64.zip
unzip aws-secretsmanager-files_1.2.34_windows_x86_64.zip
```
